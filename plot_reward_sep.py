...
window = 500
# Load data
MAsep = pd.read_csv("sac_cr_hrl/weights_final/reward.csv")
...
# Zoom to later part
axins.set_xlim(2000, 20000)
axins.set_xlabel('')
axins.set_ylabel('')
axins.set_xticklabels([])
axins.set_yticklabels([])
axins.set_ylim(MAsep['smoothed_reward'][2000:20000].min()*1.05,
               MAsep['smoothed_reward'][2000:20000].max()*0.95)
